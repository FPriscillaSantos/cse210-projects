...
public class RandomScriptures
{
    ...
    public RandomScriptures()
    {
        ...
        _scriptures.Add("Philippians 4:13", "I can do all this through him who gives me strength.");
        ...
        _scriptures.Add("D&C 18:10-11", "And it came to pass that I, Nephi, said unto my father: I will go and do the things which the Lord hath commanded, for I know that the Lord giveth no commandments unto the children of men, save he shall prepare a way for them that they may accomplish the thing which he commandeth them.");
